 ...
 *
 * SpringApplication运行方法的侦听器。SpringApplicationRunListeners是通过SpringFactoriesLoader加载的，
 * 应该声明一个接受SpringApplication实例和String[]参数的公共构造函数。
...
public interface SpringApplicationRunListener {
	 ...
	 * 在刷新应用程序上下文并且调用了所有CommandLineRunner和ApplicationRunner之后，在运行方法完成之前立即调用。
	 * @param context the application context.
